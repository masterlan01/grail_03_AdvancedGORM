...
<html>
    ...
    <body>
        ...
        <div id="show-pupil" class="content scaffold-show" role="main">
            ...
            <f:display bean="pupil" />
            <g:form resource="${this.pupil}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.pupil}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
