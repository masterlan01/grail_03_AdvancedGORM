...
<html>
    ...
    <body>
        ...
        <div id="show-squad" class="content scaffold-show" role="main">
            ...
            <f:display bean="squad" />
            <g:form resource="${this.squad}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.squad}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
